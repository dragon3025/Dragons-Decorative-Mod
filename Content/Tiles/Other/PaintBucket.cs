...
namespace DragonsDecorativeMod.Content.Tiles.Other
{
    public class PaintBucket : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/PaintBucketOverlay");
                overlayTextureNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/PaintBucketOverlayNegative");
            }
        }
