...
namespace DragonsDecorativeMod.Content.Tiles.Other
{
    public class BalloonsPaintable : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTextureStrings = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/BalloonsPaintableStrings");
                overlayTextureBack = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/BalloonsPaintableBack");
                overlayTextureFront = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/BalloonsPaintableFront");
                overlayTextureBackNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/BalloonsPaintableBackNegative");
                overlayTextureFrontNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/BalloonsPaintableFrontNegative");
            }
        }
