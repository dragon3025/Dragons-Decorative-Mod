...
namespace DragonsDecorativeMod.Content.Tiles.Other
{
    public class ThreadPlaceable : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/ThreadPlaceableOverlay");
                overlayTextureNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Other/ThreadPlaceableOverlayNegative");
            }
        }
