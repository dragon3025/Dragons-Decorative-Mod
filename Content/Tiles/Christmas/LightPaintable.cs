...
namespace DragonsDecorativeMod.Content.Tiles.Christmas
{
    public class LightPaintable : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Christmas/LightPaintableOverlay");
            }
        ...
        {
            yield return new Item(ItemType<Items.Placeable.Christmas.LightPaintable>());
        }
    }
}