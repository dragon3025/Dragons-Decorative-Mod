...
namespace DragonsDecorativeMod.Content.Tiles.Signs
{
    public class SignHeart : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorAlternateTiles = [124];
        ...
        {
            yield return new Item(ModContent.ItemType<Items.Placeable.Signs.SignHeart>());
        }
    }
}