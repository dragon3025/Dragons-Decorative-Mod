...
namespace DragonsDecorativeMod.Content.Tiles.Garden
{
    public class WallFlowers : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Garden/WallFlowersOverlay");
                overlayTextureNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Garden/WallFlowersOverlayNegative");
            }
        }
