...
namespace DragonsDecorativeMod.Content.Tiles.Garden
{
    public class FloweryPlant : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Garden/FloweryPlantOverlay");
                overlayTextureNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Garden/FloweryPlantOverlayNegative");
            }
        }
