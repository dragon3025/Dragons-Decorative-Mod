...
namespace DragonsDecorativeMod.Content.Tiles.Garden.PottedPlants
{
    public class PottedPalmTrees : ModTile
    {
        ...
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            ...
            if (style == 0)
            {
                yield return new Item(ModContent.ItemType<Items.Placeable.Garden.PottedPlants.PottedPalmCorruption>());
            }
            else
            {
                yield return new Item(ModContent.ItemType<Items.Placeable.Garden.PottedPlants.PottedPalmCrimson>());
            }
        }
