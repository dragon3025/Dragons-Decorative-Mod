...
namespace DragonsDecorativeMod.Content.Tiles.Garden.PottedPlants
{
    public class PottedXMasTrees : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Garden/PottedPlants/PlanterXMasTrees");
            }
        }
        ...
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            ...
            if (style == 0)
            {
                yield return new Item(ModContent.ItemType<Items.Placeable.Garden.PottedPlants.PottedXMasTree>());
            }
            else
            {
                yield return new Item(ModContent.ItemType<Items.Placeable.Garden.PottedPlants.PottedXMasTreeSnowy>());
            }
        }
