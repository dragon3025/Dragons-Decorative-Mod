...
namespace DragonsDecorativeMod.Content.Tiles.Natural
{
    public class MysteriousTablet : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayInnerTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Natural/MysteriousTabletOverlayInner");
                overlayOuterTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Natural/MysteriousTabletOverlayOuter");
                overlayInnerTextureNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Natural/MysteriousTabletOverlayInnerNegative");
                overlayOuterTextureNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Natural/MysteriousTabletOverlayOuterNegative");
            }
        }
