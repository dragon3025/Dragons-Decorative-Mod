...
namespace DragonsDecorativeMod.Content.Tiles.Pets
{
    public class Aquarium : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                textureAquariumFront = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumFront");
                textureAquariumNemo = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumNemo");
                texturePinkYellow = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumPinkYellow");
                textureSchoolOfFish = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumSchoolOfFish");
                textureAquariumBlueStripe = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumBlueStripe");
                textureAquariumGreen = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumGreen");
                textureAquariumBottomFeederAndCoral = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumBottomFeederAndCoral");

                textureAquariumFrontNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumFrontNegative");
                textureAquariumNemoNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumNemoNegative");
                texturePinkYellowNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumPinkYellowNegative");
                textureSchoolOfFishNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumSchoolOfFishNegative");
                textureAquariumBlueStripeNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumBlueStripeNegative");
                textureAquariumGreenNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumGreenNegative");
                textureAquariumBottomFeederAndCoralNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Pets/AquariumBottomFeederAndCoralNegative");
            }
        }
