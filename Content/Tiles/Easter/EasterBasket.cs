...
namespace DragonsDecorativeMod.Content.Tiles.Easter
{
    public class EasterBasket : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Easter/EasterBasketOverlay");
                overlayTextureNegative = ModContent.Request<Texture2D>("DragonsDecorativeMod/Content/Tiles/Easter/EasterBasketOverlayNegative");
            }
