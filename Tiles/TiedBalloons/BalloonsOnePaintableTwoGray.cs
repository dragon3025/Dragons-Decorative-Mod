...
{
    public class BalloonsOnePaintableTwoGray : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            if (!Main.dedServ)
            {
                overlayTexture = ModContent.Request<Texture2D>("DragonsDecorativeMod/Tiles/TiedBalloons/BalloonsOnePaintableTwoGrayOverlay");
            }
        }

        public override void KillMultiTile(int x, int y, int frameX, int frameY)
        {
            Item.NewItem(new EntitySource_TileBreak(x, y), x * 16, y * 16, 32, 32, ModContent.ItemType<Items.TiedBalloons.BalloonsOnePaintableTwoGray>());
        }
