...
{
    public class BalloonsOnePaintableTwoRed : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.TiedBalloons.BalloonsOnePaintableTwoRed>();
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.RedPaint, 2);
            recipe.Register();
        }
    }
}