...
{
    public class BalloonsOnePaintableTwoYellow : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<Tiles.TiedBalloons.BalloonsOnePaintableTwoYellow>();
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ItemID.YellowPaint, 2);
            recipe.Register();
        }
    }
}